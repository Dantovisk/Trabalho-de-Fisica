...
No lançamento oblíquo, consideramos um projétil de massa $$( m \)$$, lançado com uma velocidade inicial $$\vec{v_0}$$, fazendo um ângulo $$( \theta \)$$ com o solo (eixo $$( X \)$$). A trajetória descrita pelo projétil é parabólica devido à influência da gravidade $${\vec{F}_g}$$, cuja força é vertical e dirigida para baixo.
